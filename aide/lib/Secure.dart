...
class SecureCreate extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return SecureCreateState();
  }
}

class SecureCreateState extends State<SecureCreate> {
  final collection = Firestore.instance.collection('securities');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Create a secure string')),
      body: Padding(
